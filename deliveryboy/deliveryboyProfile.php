...
// Fetch company information from tbl_delivery_boy
$companyQuery = "SELECT * FROM tbl_delivery_boy WHERE user_id = $user_id";
  ...
  <div class="wrap">
    <section class="app-content">
      <div class="row">
        ...
        <div class="col-md-6">
            <p><?php echo $companyRow['delivery_boy_name']; ?></p>
