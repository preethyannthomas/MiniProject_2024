                    ...
                    <nav class="main-nav">
                        ...
                        <ul class="nav" style="font-size: 18px;">
                            <li class="submenu" id="createAccount" onclick=load()>
                                <a href="javascript:;">Sell Online</a>
                                <ul>
                                    <li><a href="#AccountCreate">Create Account</a></li>
                                    <li><a href="#listProducts">Lists Products</a></li>
                                    <li><a href="#Storage">Storage and Shipping</a></li>
                                    <li><a href="#receive">Receive Payments</a></li>
                                    <li><a href="#grow">Grow Faster</a></li>
                                    <li><a href="#help">Help and Support</a></li>
                                </ul>
                            </li>
                            <li class="submenu" id="feesAndCommission" onclick=feesAndCommission()>
                                <a href="#paymentCycle">Fees and Commission</a>
                                <ul>
                                    <li><a href="#paymentCycle">Payment Cycle</a></li>
                                    <li><a href="#fees">Fee Type</a></li>
                                    <li><a href="#gross">Calculate Gross Margin</a></li>
                                </ul>
                            </li>
                            <li class="scroll-to-section" id="learning" onclick=learn()><a>Learn</a></li>
                        </ul>
