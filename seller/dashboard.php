...
$productQuery = "SELECT p.product_id, p.product_name, p.image, p.price, p.is_available, GROUP_CONCAT(pd.colour) AS colours, GROUP_CONCAT(pd.size) AS sizes
                                            ...
                                            echo '<div class="col-md-6">
                                                <div class="widget stats-widget">
                                                    <div class="widget-body clearfix">
                                                        ...
                                                        <img src="' . $imageSrc . '" class="card-img-top" id="img2" alt="' . $product['product_name'] . '">
                                                        <p style = "color:white"> cloth</p>
                                                        </div>
                                                        <div class="col-md-6">
