...
// Fetch company information from tbl_seller
$companyQuery = "SELECT * FROM tbl_seller WHERE user_id = $user_id";
  ...
  <div class="wrap">
    <section class="app-content">
      <div class="row">
        ...
        <div class="col-md-6">
            <p><?php echo $companyRow['company_name']; ?></p>
            <p><?php echo $companyRow['seller_name']; ?></p>
            <p><?php echo $userRow['email']; ?></p>
            <p><?php echo $companyRow['gstin']; ?></p>
        </div>
</div><br><br>
