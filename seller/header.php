      ...
      <ul class="nav navbar-toolbar navbar-toolbar-right navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu animated flipInY">
            <li><a href="sellerProfile.php"><i class="zmdi m-r-md zmdi-hc-lg zmdi-account-box"></i>My Profile</a></li>
            <li><a href="sellerChangePassword.php"><i class="zmdi m-r-md zmdi-hc-lg zmdi-balance-wallet"></i>Change Password</a></li>
