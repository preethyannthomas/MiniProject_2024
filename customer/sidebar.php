...
if (!isset($_SESSION['user_id'])) {
    ...
    // SQL query to fetch customer name based on user ID
...
<aside id="menubar" class="menubar light">
  <div class="app-user">
    ...
    <img class="img-responsive black-avatar" src="../assets/images/images.png" alt="avatar" style="padding-left: 10px; width: 150px;"/>
      ...
      <br>         
          <h5><a href="javascript:void(0)" class="username" style = "text-align:center;"><?php echo $customerName ; ?></a></h5>
    ...
    <div class="menubar-scroll-inner">
      <ul class="app-menu">
       ...
       <li class="has-submenu">
          ...
          <ul class="submenu">
            <li><a href="customerAddProduct.php"><span class="menu-text">Sales Analysis</span></a></li>
